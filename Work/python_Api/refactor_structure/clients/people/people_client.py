...
from refactor_structure.clients.people.base_client import BaseClient
from refactor_structure.config import BASE_URI
from refactor_structure.util.request import APIRequest
